...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'No solo me dedico a hacer sitios web, también creo aplicaciones web con tecnologías como Next JS, React, TypeScript y Node.js con funcionalidades avanzadas.',
